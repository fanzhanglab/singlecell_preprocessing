...
TENX_IGNORE_DEPRECATED_OS=1 /data/srlab/cellranger/cellranger-6.1.1/cellranger mkfastq --id=FASTQS_dual28 --run=/data/srlab/bwh10x/$library --csv=/data/srlab/bwh10x/$library/sample_sheet_dual28.csv --barcode-mismatches=0 --jobmode=local --localcores=16 --localmem=64 --filter-dual-index --use-bases-mask=Y28,I10,I10,Y90
