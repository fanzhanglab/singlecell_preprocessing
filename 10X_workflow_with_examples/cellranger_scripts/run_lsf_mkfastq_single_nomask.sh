...
TENX_IGNORE_DEPRECATED_OS=1 /data/srlab/cellranger/cellranger-6.1.1/cellranger mkfastq --id=FASTQS_single --run=/data/srlab/bwh10x/$library --csv=/data/srlab/bwh10x/$library/sample_sheet_single.csv --barcode-mismatches=0 --jobmode=local --localcores=16 --localmem=64
